...
class virtualRaveledGrids(object):
    ...
    def __getitem__(self, index):
        ...
        return self.x0[c].ravel(), self.y0[r].ravel()
...
#    def __next__(self):
    ...
    def copySubsetFrom(self, pad_val=0):
        ...
        for key in datatype_dict.copy():
            datatype_dict[key.lower()]=datatype_dict[key]
        if hasattr(self.source, 'level'):  # copy data from another subset
            ...
            dt=datatype_dict[gdal.GetDataTypeName(band.DataType).lower()]
